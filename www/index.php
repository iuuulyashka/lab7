...
<head>
    ...
    <title>Lab 7 - Apache Kafka Очередь сообщений</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Асинхронная обработка данных через Apache Kafka</h2>
        </div>
        ...
        <div class="card">
            <h3>📨 Отправка сообщения в Kafka</h3>
        ...
        <div class="card">
            <h3>
                <span class="status-indicator status-<?php echo file_exists('processed_kafka.log') ? 'online' : 'offline'; ?>"></span>
        ...
        <div class="links">
            ...
            <a href="status.php" target="_blank" class="link-card">
                📈 Статус системы
            </a>
        </div>
    </div>
    ...
    <script>
        // Авто-обновление лога каждые 3 секунды
        setTimeout(() => {
            location.reload();
        }, 3000);
